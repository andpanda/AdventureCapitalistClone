...
export class GameData {
    public static investmentsData: Array<InvestmentData> = [{ investmentName: "Lemonade Stand", startTime: 0, own: 1, basePrice: 50, costIncrement: 0.05, duration: 1, revenue: 10, endTime: 0, isRunning: false, haveManager: true },
